...
> **Status (2026-05-27):** ADR-105 (registry-driven search URLs) + ADR-109 (honest per-source diagnostics) are **DONE/ACCEPTED** (commit `da74137`). **Remaining: ADR-106, ADR-107, ADR-108** — see the per-ADR task breakdown below; pick one per session. ADR-106 needs the Walmart 140K fixture captured first; ADR-107 needs a small live AlterLab+Scrappey spend.
