...
**Status**: PROPOSED — diagnosed 2026-05-26 from a user re-onboard; implementation deferred to the next session. No code changed in this diagnosis turn.
