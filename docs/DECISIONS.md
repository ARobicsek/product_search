...
**Status**: PROPOSED — needs user sign-off before implementation. Design only; no code in this entry. Revised 2026-05-23 to a recall-first stance (see "Guiding philosophy" below) after the original single-dominant-match framing.
